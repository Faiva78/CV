...
--
-- Host: localhost:3306
-- Generato il: Feb 04, 2016 alle 10:06
...
(6, 'es', '2016-02-01', 0, 'Teso Nicola', '1  APRILE  1978', 'Italiana', '1184  Dunaflor Verde -  35100  -  Maspalomas  -  Gran Canaria -  España', '+34 602 18 14 02\r\n\r\n+39 320 79 66 989', 'Tesonicola@Gmail.com \r\n\r\nTesonicola@Libero.it', 'Www.faiva78.com', 'Permiso  de  conducción  cat.  B');
...
CREATE TABLE IF NOT EXISTS `infot` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `language` text COLLATE utf8_bin NOT NULL,
  `data` date NOT NULL,
  `header` tinyint(1) NOT NULL,
