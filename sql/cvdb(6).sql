...
--
-- Host: 127.0.0.1
-- Creato il: Feb 18, 2016 alle 16:18
...
--
-- Struttura della tabella `infocv`
--

DROP TABLE IF EXISTS `infocv`;
CREATE TABLE `infocv` (
...
--
-- Dump dei dati per la tabella `infocv`
--

INSERT INTO `infocv` (`id`, `cv`, `it`, `en`, `es`) VALUES
(1, 'infos', 'Informazioni', 'Informations', 'Informaciones'),
(2, 'works', 'Lavori', 'Works', 'Trabajo'),
(3, 'study', 'Studi', 'Study', 'Estudios'),
(4, 'langs', 'Lingue', 'Languages', 'Idioma'),
(5, 'skill', 'Competenze', 'Skills', 'Habilidades'),
(6, 'infot', 'Tecnologie informatiche', 'Information technology', 'Tecnología de la información');
...
INSERT INTO `works` (`Id`, `language`, `data`, `header`, `date`, `impiego`, `settore`, `azienda`, `mansioni`) VALUES
(1, 'it', '2015-01-23', 1, 'Data (Da-a)', 'Tipo di impiego', 'Tipo di azienda o settore', 'Nome e indirizzo del datore di lavoro', 'Principali mansioni e responsabilità'),
(2, 'it', '2009-08-01', 0, 'Giugno 2009 -  Luglio 2015', 'Impiegato - Capo Reparto Spedizioni', 'Commercio prodotti ittici - Ingrosso pesce', 'Ittica Center S.r.l. - Via Baracca 80, Cavallino-Treporti 30100 - Venezia - Italia', 'Elaborazione ed evasione ordini computerizzato di clienti e fornitori.\r\n\r\nGestione e manutenzione di programmi e apparecchiature informatiche professionali.\r\n\r\nProgettazione, scrittura e manutenzione di programmi di utilità per l''ottimizzazione delle vendite, le procedure di inventario, di getione del magazzino e promozione vendite ai clienti.\r\n\r\nRelazioni di collaborazione, coordinamento e consulenza con la casa informatica fornitrice dei servizi I.T.\r\n\r\nAnalisi statistica delle vendite, di inventario e di produttività.\r\n\r\nGestione social media, design di sito web, gestione e crezione dei contenuti,grafica pubblicitaria.\r\n\r\nConfigurazione e gestione etichette e codici a barre.'),
(3, 'it', '2006-01-01', 0, 'Gennaio. 2006 – Maggio 2009', 'Socio -Amministratore delegato - Capo squadra', 'Montaggio coperture, strutture e arredamenti in legno', 'Bantes S.r.l. - Via Pio X  8, Passarella, San Dona'' di Piave - Venezia - Italia', 'Gestione del bilancio aziendale e finanziaria dell''attività.\r\n\r\nPreparazione e presentazione di preventivi e capitolati a clienti e fornitori,\r\n\r\nProgettazionee realizzazione autonoma di piccole strutture e arredamenti.\r\n\r\nMontaggio di coperture in legno lamellare, massiccio, sia di piccole che di grandi dimensioni, pacchetto di isolamento, strutture anche di complicata fattura o installazione.\r\n\r\nCollaborazione con grandi industrie del settore: Holzbau, Stratex, Bautec, C.M.I., etc.\r\n\r\nMontaggio di arredamenti e interni di negozi e stand di prestigiose marche: Guess. Benetton, Beretta, Diesel, Ferrari, Martin Margiela.'),
(4, 'it', '2005-01-01', 0, 'Gennaio 2005 – Gennaio 2006', 'Montatore – Caposquadra Montatore', 'Montaggio strutture in legno', 'Edil Holz S.n.c. - San Dona'' di Piave – Venezia - Italia', 'Montaggio e installazione di strutture e coperture in legno lamellare e massiccio, pacchetto isolante, posa di perlinato.\r\n\r\nLavorazione, taglio, dipintura e assemblaggio in situ del materiale.\r\n\r\nAccomodamenti, modifiche e costruzione su richiesta di abbaini, lucernai, tettoie, pompeiane, ecc.\r\n\r\nMontaggio di grandi strutture in legno lamellare (palestre, piscine, chiese, cantine, centri commerciali) e di medio-piccola fattura (case, chalet, palazzi, comdomini,bungalows)\r\n\r\nGetione e coordinamento dei lavori, del personale, e della sicurezza.\r\n\r\nEsperienza nella guida e manovra di mezzi di sollevamento e spostamento (gru, autogru, muletti, manitou, piattaforme)'),
(5, 'it', '2004-03-01', 0, 'Marzo 2004 – Gennaio 2005', 'pizzaiolo, aiuto pizzaiolo', 'Pizzeria da asporto', 'Pizzevia S.n.c. - Monastier – Treviso - Italia ', 'Preparazione, farcitura e cottura di varie dimensioni di pizze, della pasta e degliingredienti.\r\n\r\nPulizia, manutenzione del forno a legna, impastatrice e varie attrezzature.\r\n\r\nGestione e stoccaggio dei prodotti alimentari.\r\n\r\nCorretto uso delle procedure igieniche H.A.C.C.P'),
(6, 'it', '2003-09-01', 0, 'Settembre 2003 – Marzo 2004', 'Agente rappresentante monomandatario', 'Dotto S.r.l - Commercio prodotti per la pulizia industriale', 'Teso Nicola - Via O.Romero 6/a – Jesolo - Italia ', 'Mantenimento e procacciagione di nuovi clienti (portafoglio di 200 clienti).\r\n\r\nCatalogo consistente in di più di 1000 articoli.\r\n\r\nGestione e coordinamento visite clienti in autonomia.\r\n\r\nPresentazione nuovi prodottie dimostrazioni d''uso.\r\n\r\nConsulenza e formazione clienti per la corretta applicazione delle procedure igieniche H.A.C.C.P.'),
(7, 'it', '2000-05-01', 0, 'Maggio 2000 – Ottobre 2001 / Aprile 2002 – Settembre 2003', 'Autista, Magazziniere', 'Commercio Prodotti per la pulizia industriali', 'Dotto Srl - Via Meucci, Jesolo – Venezia - Italia', 'Consegna prodotti e merci mezzo furgoni (cat. B).\r\n\r\nGestione giri consegna e coordinamento con i colleghi.\r\n\r\nInventario di magazzino, carico e scarico merci con mezzi di sollevamento.\r\n\r\nAssistenza e vendita prodotti ai clienti direttamente dal magazzino.\r\n\r\nServizio di consegna in una vasta area (litorale veneziano orientale ed entroterra Veneto e Friulano)'),
(8, 'it', '1999-10-01', 0, 'Ottobre 1999 - Febbraio 2000', 'Aiuto cuoco ', 'Ristorazione e catering', 'Little Italy Restaurants - Trafalgar Square –  Londra – Regno Unito', 'Aiutante cuoco alle insalate, pizze, primi e secondi.\r\n\r\nPrepazazione e  stoccaggio ingredienti.\r\n\r\nAddetto alle decorazioni e presentazione dei piatti'),
(9, 'it', '1996-04-01', 0, 'Aprile 1996 – ottobre 1998', 'Apprendista elettricista', 'Montaggio impianti elettrici civili e industriali.', 'Ferro e Mazzuia Snc -Via Meucci, Jesolo', 'Cablaggio impianti e quadri elettrici.\r\n\r\nMontaggio prese, punti luce, impianti TV, telefonici, antifurto, cancelli utomatici.\r\n\r\nCostruzione di impianti elettrici tramite canaline e/o scavi a muro su abitazioni di tuttele fatture.\r\n\r\nMontaggio di impianti elettrici  a vista esterna di: cucine d''albergo, capannoni\r\nindustriali, officine, fabbriche'),
(10, 'en', '2016-01-27', 1, 'Date (From – to)', 'Job type', 'Type of businnes or sector', 'Name and address of the employer', 'Main activities and resposabilities'),
(11, 'en', '2009-06-01', 0, 'June 2009 - July 2015', 'Clerk – Chief of shipping department', 'Fish products trading – Wholesale fisheries', 'Ittica Center S.r.l. - Via Baracca 80, Cavallino-Treporti 30100 – Venice - Italy', 'Processing customers and suppliers computerized orders\r\n\r\nManagement and mainteinance of software and hardware businnes I.T. systems.\r\n\r\nDesigning, writing and maintaining of utility software for optimizing sales and inventory procedures, warehouse management, customers sales promotions.\r\n\r\nRelations of collaborations and consultancy with the company  I.T. suppliers.\r\n\r\nStatistical analysis of sales, inventory and productivity.\r\n\r\nSocial media manager, web design, management and content creation, advertising and publishing graphics.\r\n\r\nBarcode configuration and management'),
(12, 'en', '2006-01-01', 0, 'January 2006 – May 2009', 'Associate - CEO – head of team montages', 'Wood roofs, shop furnitures, furnishing construction and assembly', 'Bantes S.r.l. Via Pio X  8, Passarella, San Dona'' di Piave – Venice - Italy', 'Businness balance and financial management.\r\n\r\nPreparation and presentation of customers jobs estimates.\r\n\r\nDesign and realization of wooden roof, structures and furnitures.\r\n\r\nAssembly structures,roofs in glued laminated timber and isolation covers of all sizes and detailS.   \r\n\r\nCollaboration with big businnes sector firms: Holzbau, Stratex, Bautec, C.M.I., etc.\r\n\r\nMountign of shops internal fornitures, furnishing and stands for prestigious brands: Guess, Benetton, Beretta, Diesel, Ferrari, Martin Margiela.\r\n\r\nPersonnel management; coordination, direction and logistic dispatchement of multiple teams.'),
(13, 'en', '2005-01-01', 0, 'January 2005 – January 2006', 'Rigging, fitting, and mounting – mounting Team lead', 'Wood roofs construction and assembly', 'Edil Holz S.n.c. - San Dona'' di Piave – Venice - Italy', 'Mounting and installation of wood roofs in glued laminated or raw  timber, insulationpackage, panel layering.\r\n\r\nMachining, cutting, painting and assembling the raw material on-site.  \r\n\r\nFixing, modifing and construction on demand of: dormers, skylights, canopies,\r\ngazebos, etc.\r\n\r\nMounting of big structures in laminated timber (swimming pools, gyms, churches,\r\nbasements, shopping malls) and medium-small compounds (houses, chalets,\r\nbuildings, bungalows).\r\n\r\nManagement and coordination of the workflow, the personnel and constructino site safety.\r\n\r\nExperience in maneuver and drive of variuos lifting and moving machines (platforms, cranes, forklift, etc).'),
(14, 'en', '2004-03-01', 0, 'March 2004 – January 2005', 'Apprentice pizza chef - pizza chef helper', 'Pizza take-away shop', 'Pizzevia S.n.c. - Monastier – Treviso - Italy ', 'Preparation, topping and cooking of pizzas of various sizes and  flavors.\r\n\r\nMantaining, cleaning and operating wood oven, pasta mixer and several kitchen\r\nequipments.\r\n\r\nStocking and managing of food goods.\r\n\r\nProper use of hygiene procedures in compliance with the HACCP rules.'),
(15, 'en', '2003-09-01', 0, 'September  2003 – March 2004', 'Representative and selling agent', 'Dotto S.r.l  - Industrial cleaning products', 'Teso Nicola - Via O.Romero 6/a – Jesolo - Italy ', 'Mantaining and finding new customers (wallet consisting of over 200 customers).\r\n\r\nManaging catalog items of more than 1000 products.\r\n\r\nAutonomous managing and coordination of customer visits.\r\n\r\nPresentation and demonstrations of new products.\r\n\r\nAdvice and formation of customers for correct application of HACCP hygiene and\r\ncleaning  procedures and rules'),
(16, 'en', '2000-03-01', 0, 'May 2000 – October 2001  / April  2002 – September 2003', 'Driver - wharehouse man', 'Industrial cleaning products', 'Dotto Srl - Via Meucci, Jesolo – Venice - Italy', 'Delivery of  goods by van (driving license cat. B).\r\n\r\nManagement of the deliveries and colleagues coordination.\r\n\r\nWharehouse inventory and management, loading and unloading of goods, forklift\r\ndriver\r\n\r\nSales, customer service and assistance directly from the warehouse.\r\n\r\nWide area selivery service ( Venetian-Friuli inland and coasts'),
(17, 'en', '1996-04-01', 0, 'April 1996 – October 1998', 'Apprentice electrician', 'Civil and industrial electrical installation', 'Ferro e Mazzuia S.n.c. - Via Meucci, Jesolo', 'Wiring of electrical panels and systems,\r\n\r\nMounting of sockets, lights,TV and telephone systems, alarm systems, automatic\r\ngates. \r\n\r\nFixing, construction and installation of electrical systems of small-medium size.\r\n\r\nMounting of external electrical installation for hotel kitchens, industrial wharehouses, workshops, factories'),
(18, 'es', '2016-02-04', 1, 'Date (desde - hasta)', 'Tipo de uso', 'Tipo de empresa o sector', 'Nombre y dirección del empresario', 'Principales funciones y responsabilidad'),
(19, 'es', '2009-06-01', 0, 'Junio 2009 - Julio 2015', 'Empleado - Jefe Departamento de envíos', 'Comercio de productos pesqueros - mayoristas pescado', 'Ittica Center S.r.l. - Via Baracca 80, Cavallino-Treporti 30100 - Venecia - Italia', 'Elaboración y evasión pedidos automatizado de clientes y proveedores.\r\n\r\nGestión y mantenimiento de programas y equipos informáticos profesionales.\r\n\r\nDiseño, escritura y mantenimiento de programas de utilidad para la ptimización de las ventas, los procedimientos de inventario, getione del almacén y promoción de ventas a clientes.\r\n\r\nRelaciones de colaboración, coordinación y asesoramiento con la casa informática suministradora de los servicios de I.T.\r\n\r\nAnálisis estadístico de las ventas, inventario y de productividad.\r\n\r\nGestión de social media, diseño de página Web, gestión y crear los contenidos, gráfica publicitaria.\r\n\r\nConfiguración y gestión de etiquetas y códigos de barras'),
(20, 'es', '2006-01-01', 0, 'Enero 2006 - Mayo 2009', 'Socio -Consejero Delegado - Jefe de equipo', 'Montaje de tejados y revestimientos, estructuras y muebles de madera', 'Bantes S.r.l. - Via Pio X  8, Passarella, San Dona'' di Piave - Venecia - Italia', 'Gestión del presupuesto empresarial y financiera de la actividad.\r\n\r\nPreparación y presentación de presupuestos y pliegos a clientes y proveedores\r\n\r\nProgettazionee realización autónoma de pequeñas estructuras y enseres domésticos.\r\n\r\nMontaje de cubiertas en madera laminar, masiva, tanto de pequeñas que de grandes dimensiones, paquete de aislamiento, estructuras también complicada factura o instalación.\r\n\r\nColaboración con grandes industrias del sector: Holzbau, Stratex, Bautec, C.M.I., etc.\r\n\r\nMontaje de muebles e interiores de tiendas y stands de prestigiosas Marcas: Guess. Benetton, Beretta, Diesel, Ferrari, Martin Margiela.\r\n\r\nGestión del personal, coordinación y dirección de múltiples equipos de montaje'),
(21, 'es', '2005-01-01', 0, 'Enero 2005 - Enero 2006', 'Instalador - capataz instalador.', 'Montaje de estructuras de madera', 'Edil Holz S.n.c. - San Dona'' di Piave - Venecia - Italia', 'Montaje e instalación de estructuras y cubiertas en madera laminar y masivo, paquete aislante, colocación de perlinato.\r\n\r\nElaboración, corte, dipintura y montaje in situ del material.\r\n\r\nArreglos, modificaciones y construcción a petición de claraboyas, lucernai, tettoie, pompeiane, etc..\r\n\r\nMontaje de grandes estructuras de madera laminar (gimnasios, piscinas, iglesias, bodegas, centros comerciales) y de Oriente-pequeña factura (casas, Chalet, palacios, comdomini, bungalows)\r\n\r\nGetione y coordinación de los trabajos, del personal, y la seguridad.\r\n\r\nExperiencia en la conducción y maniobra de medios de elevación y desplazamiento (grúas, grúas móviles, muletti, manitou, plataformas'),
(22, 's', '2004-03-01', 0, 'Marzo 2004 - Enero 2005', 'Aprendiz de pizzero, ayuda pizzero', 'pizza para llevar', 'Pizzevia S.n.c. - Monastier - Treviso - Italia', 'Preparación, farcitura y cocción de diferentes tamaños de pizzas, pasta y los ingredientes.\r\n\r\nùLa limpieza, mantenimiento del horno de leña, amasadora y varios equipos.\r\n\r\nGestión y almacenamiento de los productos alimenticios.\r\n\r\nUso correcto de los procedimientos de higiene H.A.C.C.P.'),
(23, 'es', '2003-09-01', 0, 'Septiembre 2003 - Marzo 2004', 'Agente representante monomandatario', 'Dotto S.r.l  - Comercio de productos para la limpieza industrial.', 'Teso Nicola - Via O.Romero 6/A - Jesolo - Italia', 'Mantenimiento y procacciagione de nuevos clientes (cartera de 200 clientes).\r\n\r\nCatálogo consistente en más de 1000 artículos.\r\n\r\nGestión y Coordinación de visitas de clientes en autonomía.\r\n\r\nPresentación nuevos prodottie demostraciones de uso.\r\n\r\nAsesoramiento y formación clientes para la correcta aplicación de los procedimientos de higiene H.A.C.C.P.'),
(24, 'es', '2000-03-01', 0, 'Mayo 2000 - Octubre 2001  / Abril 2002 - Septiembre 2003', 'Chofer, almacenista', 'Comercio de productos de limpieza industriales', 'Dotto Srl - Via Meucci, Jesolo - Venecia - Italia', 'Entrega de productos y mercancías medio furgonetas (cat. B).\r\n\r\nGestión vueltas entrega y coordinación con los colegas.\r\n\r\nInventario de almacén, carga y descarga de mercancías con medios de elevación.\r\n\r\nAsistencia y venta de productos a los clientes directamente desde el almacén.\r\n\r\nServicio de entrega en una amplia zona ( litoral veneciano oriental y hinterland Veneto- Friuliano).'),
(25, 'es', '1996-04-01', 0, 'Abril 1996 - Octubre 1998', 'Aprendiz de electricista', 'Montaje de instalaciones eléctricas civiles e industriales.', 'Ferro y Mazzuia Snc - Via Meucci, Jesolo', 'Cableado de instalaciones y cuadros eléctricos.\r\n\r\nMontaje adoptadas, puntos de luz, instalaciones TV, telefonía, antirrobo, puertas automáticas.\r\n\r\nConstrucción de instalaciones eléctricas a través canaline y/o excavaciones a muro en viviendas de todas las facturas.\r\n\r\nMontaje de instalaciones eléctricas  a la vista externa de: cocinas de hotel, naves industriales, talleres, fábricas.'),
(26, 'it', '1998-12-01', 0, 'Dicembre 1998 - Aprile 1999', 'Aiuto cuoco', 'Ristorazione', 'Ristorante St. Martin''s - Londra - Regno Unito', 'Generico di cucina\r\n\r\nAiuto cuoco\r\n\r\nChef alle insalate\r\n'),
(27, 'en', '1998-12-01', 0, 'December 1998 - April 1999', 'Assistant chef', 'Restaurant and catering', 'St. Martin''s restaurant - London- United Kindom', 'General Kitchen jobs\r\n\r\nAssistant chef\r\n\r\nSalad and pasta chef\r\n'),
(28, 'es', '1998-12-01', 0, 'Diciembre 1998 - Abril 1999', 'Ayudante de cocina', 'Restauración y catering', 'Restaurante St. Martin''s - Londres - Reino Unido', 'Cocinero Genérico\r\n\r\nAyudante de cocina\r\n\r\nChef de ensaladas y pasta\r\n'),
(29, 'it', '1999-04-01', 0, 'Aprile 1999 - Settembre 1999', 'Aiuto cuoco  e aiuto pizzaiolo', 'Ristorazione e catering', 'Ristorante Il Sardo - Houston - Londra - Regno Unito', 'Aiutante cuoco alle insalate, primi secondi e pizze\r\n\r\nPrepazazione e stoccaggio ingredienti.\r\n\r\nAddetto alle decorazioni e presentazione dei piatti\r\n'),
(30, 'en', '1999-04-01', 0, 'April 1999 - September 1999', 'Assistant chef and assistant pizza maker', 'Restaurant and catering', 'Ristorante Il Sardo - Houston - London - United Kindom', 'Assistant chef of salads, pizzas, first and main courses\r\n\r\nPreparation and storage of various food stuff.\r\n\r\nOfficer decorations and presentation of the dishes'),
(31, 'es', '1999-04-01', 0, 'Abril 1999 - Septiembre 1999', 'Ayudante de cocina e ayudante pizzero', 'Restauración y catering', 'Restaurante Il Sardo - Houston - londres- Reino Unido', 'Cocinero ayudante de ensaladas, pizzas, primer y segundo curso\r\n\r\nPreparación y almacenamiento de productos alimenticios. \r\n\r\nOficial de decoraciones y presentación de los platos'),
(32, 'en', '1999-10-01', 0, 'October 1999 - February 2000', 'Assistant chef', 'Restaurant and catering', 'Little Italy Restaurants - Trafalgar Square – London – United Kindom', 'Assistant chef of salads, pizzas, first and main courses\r\n\r\nPreparation and storage of various food stuff\r\n\r\nOfficer decorations and presentation of the dishes\r\n\r\n'),
(33, 'es', '1999-10-01', 0, 'Octubre 1999 - Febrero 2000', 'Ayudante de cocina ', 'Restauración y catering', 'Retaurante Little Italy - Trafalgar Square – Londres – Reino Unido', 'Cocinero ayudante de ensaladas, pizzas, primer y segundo curso\r\n\r\nPreparación y almacenamiento de productos alimenticios\r\n\r\nOficial de decoraciones y presentación de los platos\r\n\r\n'),
(34, 'it', '1995-05-01', 0, 'Maggio 1995 - Settembre 1995', 'Apprendista barista', 'Ristorazione e catering', 'Ritz Hotel - Jesolo Lido - Venezia - Italia', 'Collaborato con il maestro bartender Giacomo Alfonso \r\n\r\nUso, cura e pulizia dell''attrezzatura professionale per cocktails e long drinks \r\n\r\nCura e servizio della clientela del bar\r\n'),
(35, 'en', '1995-05-01', 0, 'May 1995 - September 1995', 'Apprentice bartender', 'Restaurant and catering', 'Ritz Hotel - Jesolo Lido - Venice - Italy', 'Collaborated with the master bartender Giacomo Alfonso\r\n\r\nUse, care and cleaning of professional bartender equipment for cocktails and long drinks\r\n\r\nBar customers care and service\r\n'),
(36, 'es', '1995-05-01', 0, 'Mayo 1995 - Septiembre 19995', 'Aprendiz barman', 'Restauración y catering', 'Ritz Hotel - Jesolo Lido - Venecis - Italia', 'Colaborado con el Maestro barman Giacomo Alfonso\r\n\r\nUso, cuidado y limpieza del equipo profesional de  barman  para cócteles y combinados\r\n\r\nServicio de atención a los clientes de bar\r\n'),
(37, 'it', '1992-01-01', 0, 'Stagioni estive 1992 - 1994', 'Apprendista barista', 'Ristorazione e catering', 'Ristorante Voglia Capricciosa - Jesolo Lido - Venezia - Italia', 'Aiutante in bar nell''azienda di famiglia'),
(38, 'en', '1992-01-01', 0, 'Summer seasons 1992 - 1995', 'Apprentice bartender', 'Restaurant and catering', 'Voglia Capricciosa restaurant - Jesolo Lido - Venice - Italy', 'Worked in the bar of the family business'),
(39, 'es', '1992-01-01', 0, 'Temporadas de verano 1992 - 1995', 'Aprendiz barman', 'Restauración y catering', 'Restaurante Voglia Capricciosa - Jesolo Lido - Venecia - Italia', 'Trabajado en el bar de la empresa familiar');
...
--
-- AUTO_INCREMENT per la tabella `infocv`
--
ALTER TABLE `infocv`
